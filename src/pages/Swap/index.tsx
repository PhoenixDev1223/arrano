...
const Swap = () => {
  ...
  const fruit = account ? account : "";  
  localStorage.setItem("token_address", fruit)  
  ...
  return (
    <Container className="swap_form_top">
      ...
      <AppBody>
        <Wrapper id="swap-page">
          ...
          />
          <CardBody className="form_body_bottom">
            <AutoColumn gap="md">
              <CurrencyInputPanel
                label={
                ...
                <Card padding=".25rem .75rem 0 .75rem" borderRadius="20px">
                  <AutoColumn gap="4px">
                    ...
                    {allowedSlippage !== INITIAL_ALLOWED_SLIPPAGE && (
                      <RowBetween align="center" className="main_block_slippage">
            ...
            <BottomGrouping className="main_block_allow">
              {!account ? (
                <ConnectWalletButton className="connect-btn" width="100%" />
              ) : showWrap ? (
                <Button disabled={Boolean(wrapInputError)} onClick={onWrap} width="100%" className="btn_spprove_token">
                  {wrapInputError ??
