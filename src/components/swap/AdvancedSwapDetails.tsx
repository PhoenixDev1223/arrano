...
function TradeSummary({ trade, allowedSlippage }: { trade: Trade; allowedSlippage: number }) {
  ...
  return (
    <Card className="card_swap_block_trade_details">
      <CardBody className="card_swap_block_trade_details_first">
        <RowBetween>
          <RowFixed>
            <Text fontSize="14px">
...
export function AdvancedSwapDetails({ trade }: AdvancedSwapDetailsProps) {
  ...
  return (
    <AutoColumn gap="md" className="swap_main_details">
      {trade && (
        <>
          ...
          {showRoute && (
            <>
              <SectionBreak />
              <AutoColumn className="route_display_medium" style={{ padding: '0 24px' }}>
                <RowFixed>
