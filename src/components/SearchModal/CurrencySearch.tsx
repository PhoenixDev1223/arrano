...
export function CurrencySearch({
  ...
  return (
    <Column style={{ width: '100%', flex: '1 1' }} className="currency_popup">
      <PaddedColumn gap="14px" className="select_token">
        <RowBetween>
          <Text>
      ...
      <div style={{ flex: '1' }} className="select_token_list">
