...
const RecentTransactionsModal = ({ onDismiss = defaultOnDismiss, translateString }: RecentTransactionsModalProps) => {
  ...
  return (
    <Modal title={translateString(1202, 'Recent transactions')} onDismiss={onDismiss} className="main_transaction_block_popup">
      {!account && (
        <Flex justifyContent="center" flexDirection="column" alignItems="center" className="main_block">
          <Text mb="8px" bold>
      ...
      {account &&
        ...
        sortedRecentTransactions.map((sortedRecentTransaction) => {
          ...
          return (
            <>
              <Flex key={hash} alignItems="center" justifyContent="space-between" mb="4px" className="main_block">
